    ...
    <body>
        ...
        <main>
            ...
            <div class="bon-back">
                ...
                <div class="bon-in">
                    <div class="container">
                        <div class="row d-flex flex-col justify-content-start">
                            <div class="col-md-2">
                                <div class="bon-lists d-flex flex-col justify-content-start">
                                    <h3>Bonafides</h3>
                                    ...
                                    <table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="">No objection certificate</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <a href="">Project Completion certificate</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="">Attendance Certificate</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="">conduct certificate</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="">library clearance certificate</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="">Sports participation certificate</a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <a href="">Loan Availing bonafide certificate</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class=" bon-app-out col-md-9">
                                <h2>Applying character certificate</h2>
                                <div class="bon-app-in">
                                    <p>verify the following details and enter them : </p>
                                    <br>
                                    <?php
                                    ...
                                    //     if ($status !== 'Pending') {
                                    //         echo "<li>$name - Status: $status</li>";
                                    //     }
                                    // }
                                    ?>
                                    <div id="requests">
                                        <h6><b>Choose certificate</b></h6>
                                        <form action="submit_request.php" action="generate_certificate.php" action="https://api.web3forms.com/submit" method="POST">
                                            <input  type="hidden" name="access_key" value="1c557291-1a55-41cf-a043-39a09196d879">
                                            <input type="hidden" name="subject" value="Bonafide request from Arunmozhivarman.">
                                            <input type="hidden" name="from_name" value="Nova SREC">
                                            <input 
                                            type="hidden" 
                                            name="redirect" 
                                            value="http://localhost/srec-hackathon-final/applied.php" />
                                            ...
                                            <input placeholder="Arunmozhi varman" type="text" id="name" name="name" required><br>
                                            <label for="fname">Parent / Gaurdian name : </label>
                                            <input type="text" id="fname" name="fname" placeholder="Karthikeyan"><br>
                                            <label for="year">Period of studying : </label>
                                            <input placeholder="2.6 Years" type="text" id="total_years" name="total_years"><br>
                                            <br><br><br>
                                            <button type="submit" class="send-btn" name="submit" value="Send Request">Send Request</button>
                                        </form>
                                    </div>
                                    <!-- <form action="https://api.web3forms.com/submit" method="POST">
                                        ...
                                        <div class="d-flex flex-row">
                                            ...
                                            <p style="padding-top: 14px; padding-left: 5px;">The above details are true as per my knowledge .</p>
                                        </div>
